...
export const ReceivedEmailsPanel: React.FC = () => {
  ...
  if (items.length === 0) {
    return (
      <Card className="p-8 text-center"><CardContent><Inbox className="w-10 h-10 mx-auto mb-3 text-neutral-400" /><p className="text-sm text-neutral-600 dark:text-neutral-400">{t('email.received.empty', 'No received emails yet. Enable incoming mail and configure the mailbox.')}</p></CardContent></Card>
    );
  }
