...
export const PdfTypographyCard: React.FC<PdfTypographyCardProps> = ({ value, onChange }) => {
  ...
  return (
    <Card className="p-6"><CardContent><h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-1 flex items-center gap-2">
            ...
            </p><label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
