      ...
      <Card className="w-full max-w-md"><CardContent><div className="p-6">
                    ...
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <div className="border border-border rounded-lg max-h-40 overflow-y-auto mb-4">
                        ...
                        <div className="mb-6">
                          <div className="w-full"><Label className="block"><span className="mb-1.5 block">{t(
                        ...
                        <div className="flex justify-end gap-3">
                          ...
                          <Button
                                                            ...
                                                            >
                                                              <Trash2 className="w-4 h-4" />{t('events.bulkDelete.submit', 'Delete {{count}} events', { count })}</Button>
                        </div>
                      </>
                    )}
