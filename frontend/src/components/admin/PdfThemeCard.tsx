...
export const PdfThemeCard: React.FC = () => {
  ...
  return (
    <Card className="mb-6"><CardContent><div className="flex items-start gap-3 mb-4">
            ...
            </div><div className="flex flex-wrap gap-2 mb-4" role="group" aria-label={t('branding.pdfTheme.scopeLabel', 'Document type') as string}>
              {SCOPES.map((s) => (
                <button
                  key={s}
                  type="button"
            ...
            </fieldset><div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
