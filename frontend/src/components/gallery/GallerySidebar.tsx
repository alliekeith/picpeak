            ...
            <div className="gallery-sidebar-section gallery-sidebar-search p-4 border-b border-border">
              <div className="relative">
                ...
                <input
                  ...
                  className="gallery-sidebar-search-input w-full pl-10 pr-4 py-2 bg-card border border-border rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-hidden focus:ring-2 focus:ring-ring focus:border-transparent"
                />
              </div>
            </div>
          )}
