            ...
            <div className="gallery-sidebar-section gallery-sidebar-search p-4 border-b border-surface">
              <div className="relative">
                ...
                <input
                  ...
                  className="gallery-sidebar-search-input w-full pl-10 pr-4 py-2 bg-surface border border-surface rounded-lg text-theme placeholder:text-muted-theme focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
              </div>
            </div>
          )}
