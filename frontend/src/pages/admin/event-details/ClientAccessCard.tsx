                ...
                <>
                  ...
                  <div className="flex items-end gap-2">
                    ...
                    <Button
                                              ...
                                              >
                                                <Key className="w-4 h-4" />{t('clientAccess.setPin')}</Button>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                                                          ...
                                                          >
                                                            {copiedClientLink ? <CheckCircle className="w-4 h-4" /> : <Copy className="w-4 h-4" />}{copiedClientLink ? t('events.copied') : t('events.copy')}</Button>
                      </div>
