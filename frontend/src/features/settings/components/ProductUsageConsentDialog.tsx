  ...
  return (
    ...
    >
      <header className="flex items-start gap-3 px-6 pt-6 pb-4">
        <span className="mt-0.5 flex h-9 w-9 flex-none items-center justify-center rounded-full bg-accent">
      ...
      <div
        ...
        className="min-h-0 flex-auto overflow-y-auto border-y border-border px-6 py-4 space-y-4 focus:outline-hidden focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ring"
      >
