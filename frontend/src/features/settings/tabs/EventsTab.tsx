  ...
  return (
    <div className="space-y-6">
      <Card><CardContent><h2 className="text-lg font-semibold text-foreground mb-4">
                    ...
                    <div
                      className={`ml-7 pl-4 border-l border-border space-y-3 ${
                    ...
                    >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full max-w-sm px-3 py-2 border border-border rounded-lg bg-card text-foreground text-sm"
                        >
                          <option value="colors">
