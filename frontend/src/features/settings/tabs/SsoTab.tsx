...
import { Save, PlugZap, Copy, Check, UserCog, ShieldAlert, Plus, Trash2, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <Card><CardContent><div className="p-6 space-y-4">
                    ...
                    <div className="w-full"><Label className="block"><span className="mb-1.5 block">{t('settings.sso.issuerUrl', 'Issuer URL')}</span><Input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="w-full"><Label className="block"><span className="mb-1.5 block">{t('settings.sso.clientId', 'Client ID')}</span><Input
                                          value={form.oidc_client_id}
                                          onChange={(e) => set('oidc_client_id', e.target.value)}
                                        /></Label></div>
                      <div>
                        <div className="w-full"><Label className="block"><span className="mb-1.5 block">{t('settings.sso.clientSecret', 'Client Secret')}</span><Input
                                                type="password"
                    ...
                    <div className="w-full"><Label className="block"><span className="mb-1.5 block">{t('settings.sso.scopes', 'Scopes')}</span><Input
                    ...
                    <div className="w-full"><Label className="block"><span className="mb-1.5 block">{t('settings.sso.buttonLabel', 'Login button label (optional)')}</span><Input
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-neutral-200 dark:border-neutral-700">
                      <Button
                                            ...
                                            >
                                              {saveMutation.isPending && <Loader2 className="animate-spin" />}<Save className="w-4 h-4" />{t('common.save', 'Save')}</Button>
                      <Button
                                              variant="outline"
                    ...
                    {form.oidc_role_mapping_enabled && (
                      <>
                        <div className="max-w-md">
                          <div className="w-full"><Label className="block"><span className="mb-1.5 block">{t('settings.sso.roleMapping.claim', 'Roles claim (dot-path)')}</span><Input
                        ...
                        <div className="space-y-2">
                          ...
                          <Button
                                                        ...
                                                        >
                                                          <Plus className="w-4 h-4" />{t('settings.sso.roleMapping.addMapping', 'Add mapping')}</Button>
                        </div>
